...
def save_checkpoint(state, is_best, filename='/path/to/checkpoint/imagenet_checkpoints/checkpoint.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, '/path/to/checkpoint/imagenet_checkpoints/model_best.pth.tar')
